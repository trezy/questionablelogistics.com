...
/**
 * This page includes the complete Cookie Policy for the website.
 *
 * @component
 */
export function CookiePolicyPage() {
	return (
		<>
			<PageSection>
				<Content>
					<p>{'We use cookies to help improve your experience of our website at '}<Link href={'/'}>{'https://questionablelogistics.com'}</Link>{'. This cookie policy is part of Questionable Logistics Consolidated\'s '}<Link href={'/privacy-policy'}>{'Privacy Policy'}</Link>{'. It covers the use of cookies between your device and our site.'}</p>
					...
					<p>{'If you don\'t wish to accept cookies from us, you should instruct your browser to refuse cookies from '}<Link href={'/'}>{'https://questionablelogistics.com'}</Link>{'. In such a case, we may be unable to provide you with some of your desired content and services.'}</p>
				</Content>
			</PageSection>

			<PageSection id={'what-is-a-cookie'}>
				<Content>
					<h3>
						{'What is a cookie?'}
					</h3>
			...
			<PageSection id={'types-of-cookies-and-how-we-use-them'}>
				<Content>
					<h3>
						{'Types of cookies and how we use them'}
					</h3>

					<h4 id={'essential-cookies'}>
						{'Essential cookies'}
					</h4>
					...
					<h4 id={'targeting-advertising-cookies'}>
...
CookiePolicyPage.title = 'Cookie Policy'

CookiePolicyPage.structure = [
	{
	...
	},
	{
		...
		id: 'types-of-cookies-and-how-we-use-them',
		children: [
			{
			...
			},
			{
				...
				id: 'targeting-advertising-cookies',
			},
		],
	},
]
