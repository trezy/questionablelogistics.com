...
export default function AcceptableUsePolicyPage() {
	return (
		<>
			<PageSection>
				<Content>
					<p>{'This acceptable use policy covers the products, services, and technologies (collectively referred to as the "Products") provided by Questionable Logistics Consolidated under any ongoing agreement. It\'s designed to protect us, our customers, and the general Internet community from unethical, irresponsible, and illegal activity.'}</p>

					<p>{'Questionable Logistics Consolidated customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities.'}</p>

					<p>{'This policy was last reviewed on 15 July 2022.'}</p>
				</Content>
			</PageSection>

			<PageSection id={'fair-use'}>
				<Content>
					<h3>{'Fair use'}</h3>
			...
			<PageSection id={'customer-accountability'}>
				<Content>
			...
			<PageSection id={'prohibited-activity'}>
				<Content>
					<h3>{'Prohibited activity'}</h3>

					<h4 id={'copyright-infringement-and-access-to-unauthorized-material'}>
					...
					<h4 id={'spam-and-unauthorized-message-activity'}>
					...
					<h4 id={'unethical-exploitative-and-malicious-activity'}>
					...
					<h4 id={'unauthorized-use-of-questionable-logistics-consolidated-property'}>
						{'Unauthorized use of Questionable Logistics Consolidated property'}
					</h4>

					<p>{'We prohibit the impersonation of Questionable Logistics Consolidated, the representation of a significant business relationship with Questionable Logistics Consolidated, or ownership of any Questionable Logistics Consolidated property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust. '}</p>
				</Content>
			</PageSection>

			<PageSection id={'about-this-policy'}>
				<Content>
...
AcceptableUsePolicyPage.title = 'Acceptable Use Policy'

AcceptableUsePolicyPage.structure = [
	{
		title: 'Fair Use',
		id: 'fair-use',
	},
	...
	},
	{
		...
		children: [
			{
				title: 'Copyright infringement and access to unauthorized material',
				id: 'copyright-infringement-and-access-to-unauthorized-material',
			},
			{
				title: 'SPAM and unauthorized message activity',
				id: 'spam-and-unauthorized-message-activity',
			},
			{
				title: 'Unethical, exploitative, and malicious activity',
				id: 'unethical-exploitative-and-malicious-activity',
			},
			{
				title: 'Unauthorized use of Questionable Logistics Consolidated property',
				id: 'unauthorized-use-of-questionable-logistics-consolidated-property',
			},
		],
	},
	{
