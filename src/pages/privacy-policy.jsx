...
export default function PrivacyPolicyPage() {
	return (
		<Content>
			...
			<h3 id={'disclosure-of-personal-information-to-third-parties'}>
			...
			<h3 id={'international-transfers-of-personal-information'}>
			...
			<h3 id={'your-rights-and-controlling-your-personal-information'}>
			...
			<h3 id={'additional-disclosures-for-australian-privacy-act-compliance-au'}>
			...
			<h3 id={'additional-disclosures-for-general-data-protection-regulation-gdpr-compliance-eu'}>
			...
			<h3 id={'additional-disclosures-for-california-compliance-us'}>
