...
export default function PrivacyPolicyPage() {
	return (
		<>
			<PageSection>
				<Content>
					<p>{'Your privacy is important to us. It is Questionable Logistics Consolidated\'s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, '}<Link href={'https://questionablelogistics.com'}>{'https://questionablelogistics.com'}</Link>{', and other sites we own and operate. '}</p>
					...
					<p>{'This policy is effective as of 15 July 2022.'}</p>

					<p>{'Last updated: 15 July 2022'}</p>
				</Content>
			</PageSection>

			<PageSection id={'information-we-collect'}>
				<Content>
					<h3>
					...
					<ul>
						...
						<li>{'device name and manufacturer'}</li>
						<li>{'operating system name and version'}</li>
						<li>{'browser name and version'}</li>
						<li>{'browser width and height'}</li>
					</ul>
					...
					<h4 id={'legitimate-reasons-for-processing-your-personal-information'}>
					...
					<h4 id={'collection-and-use-of-information'}>
					...
					<h4 id={'security-of-your-personal-information'}>
					...
					<h4 id={'how-long-we-keep-your-personal-information'}>
			...
			<PageSection id={'childrens-privacy'}>
				<Content>
			...
			<PageSection id={'disclosure-of-personal-information-to-third-parties'}>
				<Content>
					...
					<ul>
						<li>{'Ackee (hosted by Trezy.com)'}</li>
					</ul>
				</Content>
			</PageSection>

			<PageSection id={'international-transfers-of-personal-information'}>
				<Content>
			...
			<PageSection id={'your-rights-and-controlling-your-personal-information'}>
				<Content>
			...
			<PageSection id={'use-of-cookies'}>
				<Content>
					...
					<p>{'Please refer to our '}<Link href={'/cookie-policy'}>{'Cookie Policy'}</Link>{' for more information.'}</p>
				</Content>
			</PageSection>

			<PageSection id={'business-transfers'}>
				<Content>
			...
			<PageSection id={'limits-of-our-policy'}>
				<Content>
			...
			<PageSection id={'changes-to-this-policy'}>
				<Content>
			...
			<PageSection id={'additional-disclosures-for-australian-privacy-act-compliance-au'}>
				<Content>
					<h3>{'Additional Disclosures for Australian Privacy Act Compliance (AU)'}</h3>

					<h4 id={'international-transfers-of-personal-information'}>
			...
			<PageSection id={'additional-disclosures-for-general-data-protection-regulation-gdpr-compliance-eu'}>
				<Content>
					<h3>{'Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU)'}</h3>

					<h4 id={'data-controller-data-processor'}>
						{'Data Controller / Data Processor'}
					</h4>

					<p>{'The GDPR distinguishes between organisations that process personal information for their own purposes (known as "data controllers") and organizations that process personal information on behalf of other organizations (known as "data processors"). We, Questionable Logistics Consolidated, located at the address provided in our Contact Us section, are a Data Controller and/or Processor with respect to the personal information you provide to us.'}</p>

					<h4 id={'legal-bases-for-processing-your-personal-information'}>
					...
					<h5 id={'performance-of-a-contract-or-transaction'}>
					...
					<h5 id={'our-legitimate-interests'}>
					...
					<h4 id={'international-transfers-outside-of-the-european-economic-area-eea'}>
					...
					<h4 id={'your-rights-and-controlling-your-personal-information-2'}>
			...
			<PageSection id={'additional-disclosures-for-california-compliance-us'}>
				<Content>
					...
					<h4 id={'cookies-and-pixels'}>
						{'Cookies and Pixels'}
					</h4>

					<p>{'At all times, you may decline cookies from our site if your browser permits. Most browsers allow you to activate settings on your browser to refuse the setting of all or some cookies. Accordingly, your ability to limit cookies is based only on your browser\'s capabilities. Please refer to the '}<Link href={'#use-of-cookies'}>{'Cookies'}</Link>{' section of this privacy policy for more information.'}</p>

					<h4 id={'ccpa-permitted-financial-incentives'}>
			...
			<PageSection id={'contact-us'}>
				<Content>
					...
					<p>
						{'QLC'}<br />
						<Link href={'mailto:privacy@questionablelogistics.com'}>{'privacy@questionablelogistics.com'}</Link>
					</p>
				</Content>
			</PageSection>
		</>
...
PrivacyPolicyPage.structure = [
	{
		...
		children: [
			...
			},
			{
				...
				id: 'legitimate-reasons-for-processing-your-personal-information',
			},
			{
				title: 'Collection and Use of Information',
				id: 'collection-and-use-of-information',
			},
			{
	...
	},
	{
		...
		id: 'disclosure-of-personal-information-to-third-parties',
	},
	{
	...
	{
		title: 'Additional Disclosures for Australian Privacy Act Compliance (AU)',
		id: 'additional-disclosures-for-australian-privacy-act-compliance-au',
		children: [
			{
				title: 'International Transfers of Personal Information',
				id: 'international-transfers-of-personal-information',
	...
	},
	{
		...
		id: 'additional-disclosures-for-general-data-protection-regulation-gdpr-compliance-eu',
		children: [
			{
				title: 'Data Controller / Data Processor',
				id: 'data-controller-data-processor',
			},
			{
				title: 'Legal Bases for Processing Your Personal Information',
				id: 'legal-bases-for-processing-your-personal-information',
				children: [
					{
						title: 'Consent From You',
						id: 'consent-from-you',
					},
					{
						title: 'Performance of a Contract or Transaction',
						id: 'performance-of-a-contract-or-transaction',
					},
					{
						title: 'Our Legitimate Interests',
						id: 'our-legitimate-interests',
					},
					{
			...
			{
				title: 'International Transfers Outside of the European Economic Area (EEA)',
				id: 'international-transfers-outside-of-the-european-economic-area-eea',
			},
			{
				title: 'Your Rights and Controlling Your Personal Information',
				id: 'your-rights-and-controlling-your-personal-information-2',
			},
		],
	},
	{
		title: 'Additional Disclosures for California Compliance (US)',
		id: 'additional-disclosures-for-california-compliance-us',
		children: [
			{
				title: 'Do Not Track',
				id: 'do-not-track',
			},
			{
				...
				id: 'cookies-and-pixels',
			},
			{
				title: 'CCPA-permitted financial incentives',
				id: 'ccpa-permitted-financial-incentives',
			},
			{
